...
var kbConfigRegistry = []KBConfigField{
	...
	{Key: "tabular_embed_max_rows", Type: FieldInt, Group: "Tabular", Label: "Max embedded rows per table region", Help: "Per table region: rows beyond are not embedded (SQL only).", Min: f(0), Max: f(1_000_000), RequiresReingest: true},
