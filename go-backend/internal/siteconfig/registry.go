...
var kbConfigRegistry = []KBConfigField{
	...
	{Key: "chat_tabular_router_enabled", Type: FieldBool, Group: "Tabular", Label: "Tabular router", Help: "Deterministic pre-pass that turns table questions into validated read-only SQL before falling back to normal retrieval; kill switch effective only together with chat_tabular_query_enabled."},
