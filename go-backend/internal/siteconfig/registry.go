...
var kbConfigRegistry = []KBConfigField{
	...
	{Key: "chat_kb_router_enabled", Type: FieldBool, Group: "Orchestrator", Label: "KB-Router", Help: "Lässt bei einer Chat-Anfrage mit ?route=auto ein Fast-Tier-Modell die passende Wissensbasis aus den dem Nutzer zugänglichen KBs auswählen (1 zusätzlicher Modellaufruf). Wirkt nur bei Anfragen, die explizit Auto-Routing anfordern — normale Anfragen mit fest gewählter KB sind unberührt. Standardmäßig aus."},
	...
	{Key: "chat_factuality_gate_enabled", Type: FieldBool, Group: "Verifikation", Label: "Korrektur-Schleife", Help: "Schreibt die Antwort neu und prüft sie danach erneut (2 zusätzliche LLM-Aufrufe, ca. 1500 ms länger), wenn die vertiefte Aussagenprüfung oder Self-RAG nicht belegte Aussagen gefunden hat. Standardmäßig aus."},
