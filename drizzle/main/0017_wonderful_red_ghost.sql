...
--> statement-breakpoint
ALTER TABLE "group_kbs" ADD CONSTRAINT "group_kbs_group_id_groups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "group_kbs" ADD CONSTRAINT "group_kbs_kb_id_knowledge_bases_id_fk" FOREIGN KEY ("kb_id") REFERENCES "public"."knowledge_bases"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "group_kbs_kb_id_idx" ON "group_kbs" USING btree ("kb_id");--> statement-breakpoint
