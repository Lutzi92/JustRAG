...
ALTER TABLE "files" ADD CONSTRAINT "files_kb_id_knowledge_bases_id_fk" FOREIGN KEY ("kb_id") REFERENCES "public"."knowledge_bases"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "knowledge_base_shares" ADD CONSTRAINT "knowledge_base_shares_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "knowledge_bases" ADD CONSTRAINT "knowledge_bases_ai_config_id_ai_providers_id_fk" FOREIGN KEY ("ai_config_id") REFERENCES "public"."ai_providers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
