...
import KbCatalogModal from './KbCatalogModal';
...
function renderModal(onSubscriptionChange = vi.fn()) {
    return render(
        <KbCatalogModal isOpen onClose={vi.fn()} onSubscriptionChange={onSubscriptionChange} />
    );
}

describe('KbCatalogModal', () => {
    beforeEach(() => {
        vi.resetAllMocks();
